...
class ViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func append(){
        fetchPostdata { (posts) in
            for post in posts {
                self.models.append(InstagramPost(numberOfLikes: String(post.title), username: post.title, userImageName: "https://upload.wikimedia.org/wikipedia/commons/e/e8/Pomayrols_nature.JPEG", postImageName: "http://localhost:3000/images/1597672784648364be8860e8d72b4358b5e88099a935a.png"))
            }
        }
    }
